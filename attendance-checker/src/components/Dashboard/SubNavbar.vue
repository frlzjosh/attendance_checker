<template>
    <div class="mt-3 mb-3 row subnav">
      <div v-if="$route.path === '/dashboard'" class=" text-center col-12">
        <p class="subnav__scroll--bold subnav_scroll">Dashboard</p>
      </div>
        <div v-if="$route.path !== '/dashboard'" class="col-4 text-center">
            <p class="subnav__scroll"><strong>{{currentClass}}</strong></p>
        </div>
        <div v-if="$route.path !== '/dashboard'" class="col-4 text-center">
